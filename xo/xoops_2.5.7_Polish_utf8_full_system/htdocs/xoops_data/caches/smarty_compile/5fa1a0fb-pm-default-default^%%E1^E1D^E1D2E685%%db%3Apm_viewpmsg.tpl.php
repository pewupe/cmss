<?php /* Smarty version 2.6.28, created on 2015-03-31 10:25:50
...
", "allbox");' type='checkbox' value='Check All' /></th>
            <th><img class='bnone' src='<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/images/download.gif'; ?>' alt=''/></th>
            <th>&nbsp;</th>
            <?php if ($this->_tpl_vars['op'] == 'out'): ?>
                <th><?php echo @_PM_TO; ?>
</th>
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/Frameworks/moduleclasses/icons/16/mail_read.png'; ?>' alt='<?php echo @_PM_READ; ?>
' title='<?php echo @_PM_READ; ?>
'/></td>
                <?php else: ?>
                    <td class='aligntop width5 txtcenter'><img src='<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/Frameworks/moduleclasses/icons/16/mail_notread.png'; ?>' alt='<?php echo @_PM_NOTREAD; ?>

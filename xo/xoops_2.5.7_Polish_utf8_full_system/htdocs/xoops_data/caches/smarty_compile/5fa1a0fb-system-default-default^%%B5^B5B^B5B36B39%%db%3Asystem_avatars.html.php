<?php /* Smarty version 2.6.28, created on 2015-03-31 09:56:39
...
">
                    <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/avatar_system.png'; ?>" alt="<?php echo @_AM_SYSTEM_AVATAR_SYSTEM; ?>
" />
                </a>
...
">
                    <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/avatar_custom.png'; ?>" alt="<?php echo @_AM_SYSTEM_AVATAR_CUSTOM; ?>
" />
                </a>
...
">
                <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/user_edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_AVATAR_USERS; ?>
" />
            </a>
            <?php else: ?>
            <img class="cursorhelp tooltip" src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/forum.png'; ?>" alt="<?php echo $this->_tpl_vars['avatar']['count']; ?>

<?php /* Smarty version 2.6.28, created on 2015-05-09 19:15:56
...
">
            <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_USERRANK_ADD; ?>
" />
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['userrank']['rank_special']): ?><?php echo @_AM_SYSTEM_USERRANK_OFF; ?>
...
">
                <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_USERRANK_EDIT; ?>
" />
            </a>
...
">
                <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_AM_SYSTEM_USERRANK_DELETE; ?>
" />
            </a>
        </td>
    </tr>

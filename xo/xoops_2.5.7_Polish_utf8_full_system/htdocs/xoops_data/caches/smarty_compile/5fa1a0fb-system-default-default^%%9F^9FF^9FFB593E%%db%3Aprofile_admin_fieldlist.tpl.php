...
"><img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/Frameworks/moduleclasses/icons/16/'; ?><?php echo $this->_tpl_vars['field']['field_required']; ?>
...
"><img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/Frameworks/moduleclasses/icons/16/edit.png'; ?>" alt="<?php echo @_EDIT; ?>
" title="<?php echo @_EDIT; ?>
" /></a>
                        <?php endif; ?>
...
"><img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/Frameworks/moduleclasses/icons/16/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
" title="<?php echo @_DELETE; ?>
"</a>
                        <?php endif; ?>
                    </td>

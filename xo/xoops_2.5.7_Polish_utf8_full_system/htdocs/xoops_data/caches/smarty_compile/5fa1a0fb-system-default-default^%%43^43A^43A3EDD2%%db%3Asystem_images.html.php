<?php /* Smarty version 2.6.28, created on 2015-03-31 09:54:43
...
">
            <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_ADDCAT; ?>
" />
...
">
            <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_ADDIMG; ?>
" />
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="" title="<?php if ($this->_tpl_vars['cat']['display']): ?><?php echo @_AM_SYSTEM_IMAGES_OFF; ?>
...
">
                    <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/display.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_VIEW; ?>
" />
                </a>
...
">
                    <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_EDIT; ?>
" />
                </a>
...
">
                    <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/delete.png'; ?>" alt="" />
                </a>
                <?php endif; ?>
            </td>
        </tr>
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php echo @_IMGDISPLAY; ?>
...
">
                    <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
" />
                </a>
                 <img class="tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['img']['image_id']; ?>
, true, true, 'slide', 'slide', 120, 350);" src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/url.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_URL; ?>

<?php /* Smarty version 2.6.28, created on 2015-03-31 10:25:51
         compiled from /var/www/html/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/themes/default/theme.html */ ?>
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/themes/default/icons/favicon.ico'; ?>" />
    <link rel="icon" type="image/png" href="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/themes/default/icons/favicon.png'; ?>" />

    <!-- Sheet Css -->
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/xoops.css'; ?>" />
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/themes/default/style.css'; ?>" />
	<!--[if lte IE 8]>
		<link rel="stylesheet" href="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/themes/default/styleIE8.css'; ?>" type="text/css" />
	<![endif]-->
...
<table cellspacing="0">
    <tr id="header">
        <td id="headerlogo"><a href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/'; ?>" title="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
"><img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/themes/default/xoops-logo.png'; ?>" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>

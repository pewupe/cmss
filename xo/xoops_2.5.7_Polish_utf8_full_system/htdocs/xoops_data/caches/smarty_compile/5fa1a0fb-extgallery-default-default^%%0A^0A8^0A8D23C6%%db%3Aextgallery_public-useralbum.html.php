<?php /* Smarty version 2.6.28, created on 2015-04-27 22:30:32
         compiled from db:extgallery_public-useralbum.html */ ?>
...
</a> <img src="images/breadcrumb-link.gif" alt="BreadCrumb" /> <?php echo $this->_tpl_vars['lang']['albumName']; ?>

	<div class="center">
		<div class="bold"><?php echo $this->_tpl_vars['extgallerySortbyOrderby']; ?>
</div>
		<div class="margin-top10">
			<a href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-useralbum.php?id=<?php echo $this->_tpl_vars['extgalleryUID']; ?>
...
" href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-userphoto.php?photoId=<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_id']; ?>
...
" /></a>	
           ...
           <!-- Start Tooltip show -->
	         <?php if ($this->_tpl_vars['use_ajax_effects'] == tooltip): ?>
		         <?php if ($this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_serveur'] && $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_name']): ?>
					<a class="screenshot" title="<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_title']; ?>
" href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-userphoto.php?photoId=<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_id']; ?>
...
">                
						<div class="details">
							<?php if ($this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_serveur'] && $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_name']): ?>
							<div align="center"><a title="<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_title']; ?>
" href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-userphoto.php?photoId=<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_id']; ?>
...
" /></a></li>
         ...
         <?php if ($this->_tpl_vars['enable_info']): ?>
				...
				<div class="photoTitle"><h2><a title="<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_title']; ?>
" href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-userphoto.php?photoId=<?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_id']; ?>
"><?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_title']; ?>
</a></h2></div>
				<?php endif; ?>
				...
				<div class="photoDesc"><h5><?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_hits']; ?>
 <?php echo $this->_tpl_vars['lang']['hits']; ?>
				...
				<div class="photoExtra"><h5><?php echo $this->_tpl_vars['photos'][$this->_sections['photo']['index']]['photo_comment']; ?>

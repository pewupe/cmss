<?php /* Smarty version 2.6.28, created on 2015-05-09 19:12:42
         compiled from db:extgallery_public-photo.html */ ?>
...
if ($this->_foreach['breadcrumb']['total'] > 0):
 ...
 ?> <img src="images/breadcrumb-link.gif" alt="BreadCrumb" /> <a href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-<?php if ($this->_tpl_vars['node']['cat_isalbum']): ?><?php echo $this->_tpl_vars['display_type']; ?>
<?php else: ?>categories<?php endif; ?>.php?id=<?php echo $this->_tpl_vars['node']['cat_id']; ?>
"><?php echo $this->_tpl_vars['node']['cat_name']; ?>
</a><?php endforeach; endif; unset($_from); ?> <img src="images/breadcrumb-link.gif" alt="BreadCrumb" /> <?php echo $this->_tpl_vars['photo']['photo_title']; ?>


	<table id="photoNav" class="outer">
		<tr>
			<td id="photoNavLeft" class="even"><?php if ($this->_tpl_vars['prevId'] != 0): ?><a href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-photo.php?photoId=<?php echo $this->_tpl_vars['prevId']; ?>
">&lt;&lt; <?php echo $this->_tpl_vars['lang']['preview']; ?>
 ...
 <?php echo $this->_tpl_vars['totalPhoto']; ?>
			...
			<td id="photoNavRight" class="even"><?php if ($this->_tpl_vars['nextId'] != 0): ?><a href="<?php echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/extgallery/'; ?>public-photo.php?photoId=<?php echo $this->_tpl_vars['nextId']; ?>
...
" />
	...
	<?php if (count($this->_tpl_vars['pluginPhotoAlbumLink'])):
    foreach ($this->_tpl_vars['pluginPhotoAlbumLink'] as $this->_tpl_vars['pluginLink']):
 ?>
	<div class="txtcenter">
        <a href="<?php echo $this->_tpl_vars['pluginLink']['link']; ?>
<?php echo $this->_tpl_vars['photo']['photo_id']; ?>
" title="<?php echo $this->_tpl_vars['pluginLink']['name']; ?>
"><?php echo $this->_tpl_vars['pluginLink']['name']; ?>
</a>
    </div>
	<?php endforeach; endif; unset($_from); ?>
	<?php if (count($this->_tpl_vars['photo']['link'])):
    foreach ($this->_tpl_vars['photo']['link'] as $this->_tpl_vars['pluginLink']):
 ?>
	<div class="txtcenter">
        <a href="<?php echo $this->_tpl_vars['pluginLink']['link']; ?>
<?php echo $this->_tpl_vars['photo']['photo_id']; ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'db:extgallery_public-bookmarkme.html', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

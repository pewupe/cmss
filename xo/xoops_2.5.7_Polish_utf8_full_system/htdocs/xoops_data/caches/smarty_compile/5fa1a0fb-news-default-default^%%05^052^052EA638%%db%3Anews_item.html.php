<?php /* Smarty version 2.6.28, created on 2015-04-28 10:06:56
...
"><?php echo $this->_tpl_vars['story']['topic_title']; ?>
 : <?php echo $this->_tpl_vars['story']['news_title']; ?>
...
&nbsp;<?php endif; ?><?php if ($this->_tpl_vars['story']['poster'] != ''): ?><span class="itemPoster"><?php echo $this->_tpl_vars['lang_postedby']; ?>
 ...
 <?php echo $this->_tpl_vars['lang_reads']; ?>
		...
		<tr>
			<td class="itemBody">
				...
				<?php if ($this->_tpl_vars['articlePicture'] != ''): ?><img src="<?php echo $this->_tpl_vars['articlePicture']; ?>
" alt="" align="left" style="margin-right: 5px; margin-bottom: 5px" /><?php endif; ?>
...
</a> - <?php endif; ?><span class="itemPermaLink"><?php echo $this->_tpl_vars['story']['morelink']; ?>
</span></td>
		</tr>
		</table>
	</td>

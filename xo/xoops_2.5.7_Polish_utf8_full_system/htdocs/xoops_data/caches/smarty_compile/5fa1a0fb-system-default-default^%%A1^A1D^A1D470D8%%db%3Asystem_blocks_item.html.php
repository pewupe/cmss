<?php /* Smarty version 2.6.28, created on 2015-03-31 10:10:07
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/block.png'; ?>" alt="<?php echo @_AM_SYSTEM_BLOCKS_DRAG; ?>
...
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['item']['visible']): ?><?php echo @_AM_SYSTEM_BLOCKS_HIDE; ?>
...
">
            <img src="<?php 
echo 'http://localhost/xo/xoops_2.5.7_Polish_utf8_full_system/htdocs/modules/system/images/icons/default/clone.png'; ?>" alt="<?php echo @_AM_SYSTEM_BLOCKS_CLONE; ?>
" />
        </a>
    </div>
</div>

<?php /* Smarty version 2.6.28, created on 2015-05-09 20:18:21
         compiled from db:xforum_admin_visibility.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:xforum_admin_visibility.html', 12, false),)), $this); ?>
<br />
<div class="head">
...
?>
                            ...
                            <li>
                                <?php echo @_AM_XFORUM_FIELDVISIBLEFOR; ?>
 <?php echo $this->_tpl_vars['groups'][$this->_tpl_vars['user_gid']]; ?>

                                <?php echo @_AM_XFORUM_FIELDVISIBLEON; ?>
...
" />
                ...
                <?php else: ?>
                    <?php echo @_AM_XFORUM_FIELDNOTVISIBLE; ?>

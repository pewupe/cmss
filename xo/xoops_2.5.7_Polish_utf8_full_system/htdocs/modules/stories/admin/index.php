...
function lastStories() {
	...
	$storyarray = NewsStory::getPublished(10, 0, 0, '', 1);
    	echo "<table border='1' width='100%'><tr class='bg3'><td align='center'>"._AM_TOCID."</td><td align='center'>"._AM_STORYID."</td><td align='center'>"._AM_TITLE."</td><td align='center'>"._AM_TOPIC."</td><td align='center'>"._AM_POSTER."</td><td align='center' class='nw'>"._AM_PUBLISHED."</td><td align='center' class='nw'>"._AM_EXPIRED."</td><td align='center'>"._AM_ACTION."</td></tr>";
		...
		$topic = $eachstory->topic();
        	echo "
        	<tr><td align='center'><b>".$eachstory->tocid()."</b>
		<td align='center'><b>".$eachstory->storyid()."</b>
        	</td><td align='left'><a href='".XOOPS_URL."/modules/".$xoopsModule->dirname()."/article.php?storyid=".$eachstory->storyid()."'>".$eachstory->title()."</a>
        	</td><td align='center'>".$topic->topic_title()."
        	</td><td align='center'><a href='".XOOPS_URL."/userinfo.php?uid=".$eachstory->uid()."'>".$eachstory->uname()."</a></td><td align='center' class='nw'>".$published."</td><td align='center'>".$expired."</td><td align='center'><a href='index.php?op=edit&amp;storyid=".$eachstory->storyid()."'>"._AM_EDIT."</a>-<a href='index.php?op=delete&amp;storyid=".$eachstory->storyid()."'>"._AM_DELETE."</a>-<a href='index.php?op=moveup&amp;storyid=".$eachstory->storyid()."'>"._AM_MOVEUP."</a>";
        	echo "</td></tr>\n";
    	}
    	echo "</table><br />";

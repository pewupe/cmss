<?php
// $Id: index.php,v 1.1 2003/10/14 06:23:14 mikhail Exp $
//  ------------------------------------------------------------------------ //
...
include_once XOOPS_ROOT_PATH."/modules/altern8news/class/class.newsstory.php";
$op = 'default';
...
function modTopic() {
	...
	global $xoopsModule;
	$xt = new XoopsTopic($xoopsDB->prefix("temen"), $HTTP_POST_VARS['topic_id']);
	$topics_array = XoopsLists::getImgListAsArray(XOOPS_ROOT_PATH."/modules/altern8news/images/topics/");
	xoops_cp_header();
	echo "<h4>"._AM_CONFIG."</h4>";
	//$xoopsModule->printAdminMenu();
